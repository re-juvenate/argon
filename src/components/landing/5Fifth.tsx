...
const Fifth = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full min-h-[80vh] bg-[#0a0a0a] overflow-hidden flex items-center justify-center border-t border-neutral-900/50"
    >
      ...
      <div className="relative z-10 pointer-events-auto">
        <button className="group relative px-12 py-6 bg-white text-black font-black text-5xl md:text-7xl tracking-tighter hover:scale-105 transition-transform duration-300">
          Deploy the app!
        </button>
      </div>
    </div>
